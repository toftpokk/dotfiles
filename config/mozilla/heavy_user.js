...
user_pref("network.http.referer.XOriginPolicy", 0); // Fix icloud problem
user_pref("javascript.options.wasm", true);
user_pref("network.dns.disableIPv6", false); // Fix localhost access problem. See https://github.com/arkenfox/user.js/issues/1053
...
// The letterboxing pref is 4504 and is currently independent of 4501. FYI: this is the pref that creates borders around your webpages: if you want dark borders, use the hidden pref ui.systemUsesDarkTheme = 1
